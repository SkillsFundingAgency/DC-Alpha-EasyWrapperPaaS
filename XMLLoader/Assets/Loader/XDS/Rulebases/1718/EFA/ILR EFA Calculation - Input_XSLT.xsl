0<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="xs">
		...
		<session-data>
			...
			<entity>
				...
				<xsl:for-each select="LearningDelivery">
					...
					<xsl:variable name="var_LrnDelFAM_LDM1" select="@LearrnDelFAM_LDM1"/>

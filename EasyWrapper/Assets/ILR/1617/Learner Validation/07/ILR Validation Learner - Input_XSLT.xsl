		...
		<session-data>
			...
			<entity>
				...
				<xsl:for-each select="global">
					...
					<xsl:variable name="var_FCT_1618APPS1617" select="@FCT_1618APPS1617"/>
					<xsl:variable name="var_FCT_16-18NLA1617" select="@FCT_16-18NLA1617"/>
					<xsl:variable name="var_FCT_1618NLA1718" select="@FCT_1618NLA1718"/>
					<xsl:variable name="var_FCT_24PlusALLB1617" select="@FCT_24PlusALLB1617"/>
					<xsl:variable name="var_FCT_24PlusALLBC1617" select="@FCT_24PlusALLBC1617"/>
					<xsl:variable name="var_FCT_AAC1617" select="@FCT_AAC1617"/>
					<xsl:variable name="var_FCT_AATO1617" select="@FCT_AATO1617"/>
					<xsl:variable name="var_FCT_ANILA1617" select="@FCT_ANILA1617"/>
					<xsl:variable name="var_FCT_ANLA1718" select="@FCT_ANLA1718"/>
					<xsl:variable name="var_FCT_ASC1617" select="@FCT_ASC1617"/>
					<xsl:variable name="var_FCT_ASTO1617" select="@FCT_ASTO1617"/>
					<xsl:variable name="var_FCT_ESF1420" select="@FCT_ESF1420"/>
					<xsl:variable name="var_FCT_LEVY1799" select="@FCT_LEVY1799"/>
					<xsl:variable name="var_FCT_OLASS1617" select="@FCT_OLASS1617"/>
					...
					<instance>
						...
						<xsl:if test="string(boolean($var_FCT_1618APPS1617)) != 'false'">
							<attribute>
								<xsl:attribute name="id">FCT_1618APPS1617</xsl:attribute>
								<boolean-val>
									<xsl:value-of select="string($var_FCT_1618APPS1617)"/>
								</boolean-val>
							</attribute>
						</xsl:if>
						<xsl:if test="string(boolean($var_FCT_16-18NLA1617)) != 'false'">
							<attribute>
								<xsl:attribute name="id">FCT_16-18NLA1617</xsl:attribute>
								<boolean-val>
									<xsl:value-of select="string($var_FCT_16-18NLA1617)"/>
								</boolean-val>
							</attribute>
						</xsl:if>
						...
						<xsl:if test="string(boolean($var_FCT_24PlusALLB1617)) != 'false'">
							<attribute>
								<xsl:attribute name="id">FCT_24PlusALLB1617</xsl:attribute>
								<boolean-val>
									<xsl:value-of select="string($var_FCT_24PlusALLB1617)"/>
								</boolean-val>
							</attribute>
						</xsl:if>
						<xsl:if test="string(boolean($var_FCT_24PlusALLBC1617)) != 'false'">
							<attribute>
								<xsl:attribute name="id">FCT_24PlusALLBC1617</xsl:attribute>
								<boolean-val>
									<xsl:value-of select="string($var_FCT_24PlusALLBC1617)"/>
								</boolean-val>
							</attribute>
						</xsl:if>
						<xsl:if test="string(boolean($var_FCT_AAC1617)) != 'false'">
							<attribute>
								<xsl:attribute name="id">FCT_AAC1617</xsl:attribute>
								<boolean-val>
									<xsl:value-of select="string($var_FCT_AAC1617)"/>
								</boolean-val>
							</attribute>
						</xsl:if>
						<xsl:if test="string(boolean($var_FCT_AATO1617)) != 'false'">
							<attribute>
								<xsl:attribute name="id">FCT_AATO1617</xsl:attribute>
								<boolean-val>
									<xsl:value-of select="string($var_FCT_AATO1617)"/>
								</boolean-val>
							</attribute>
						</xsl:if>
						<xsl:if test="string(boolean($var_FCT_ANILA1617)) != 'false'">
							<attribute>
								<xsl:attribute name="id">FCT_ANILA1617</xsl:attribute>
								<boolean-val>
									<xsl:value-of select="string($var_FCT_ANILA1617)"/>
								</boolean-val>
							</attribute>
						</xsl:if>
						...
						<xsl:if test="string(boolean($var_FCT_ASC1617)) != 'false'">
							<attribute>
								<xsl:attribute name="id">FCT_ASC1617</xsl:attribute>
								<boolean-val>
									<xsl:value-of select="string($var_FCT_ASC1617)"/>
								</boolean-val>
							</attribute>
						</xsl:if>
						<xsl:if test="string(boolean($var_FCT_ASTO1617)) != 'false'">
							<attribute>
								<xsl:attribute name="id">FCT_ASTO1617</xsl:attribute>
								<boolean-val>
									<xsl:value-of select="string($var_FCT_ASTO1617)"/>
								</boolean-val>
							</attribute>
						</xsl:if>
						...
						<xsl:if test="string(boolean($var_FCT_OLASS1617)) != 'false'">
							<attribute>
								<xsl:attribute name="id">FCT_OLASS1617</xsl:attribute>
								<boolean-val>
									<xsl:value-of select="string($var_FCT_OLASS1617)"/>
								</boolean-val>
							</attribute>
						</xsl:if>

			...
			convert(xml,
				(
					select
						...
						case when [LearningProvider_vw_ContractValidation_16-18NLA1718].[UKPRN] is not null then 'true' else 'false' end as [@FCT_16-18NLA1617],
						...
						case [LearningProvider_vw_ContractValidation_ANLA1617].[UKPRN] when 1 then 'true' when 0 then 'false' end as [@FCT_ANLA1617],
						(
							select
					...
					from
						...
						(
							...
							from 
								[$(FCT)].[$(FCT_Schema)].[vw_ContractValidation]
						) as [LearningProvider_vw_ContractValidation_16-18NLA1718]
							on [LearningProvider_vw_ContractValidation_16-18NLA1718].[UKPRN] = [LearningProvider].[UKPRN]
							and [LearningProvider_vw_ContractValidation_16-18NLA1718].[fundingStreamPeriodCode] = '16-18NLA1718'
						left join 
						(
							select  distinct
								[vw_ContractValidation].[UKPRN],
							...
							from
								[$(FCT)].[$(FCT_Schema)].[vw_ContractValidation]
						) as [LearningProvider_vw_ContractValidation_ANLA1617]
							on [LearningProvider_vw_ContractValidation_ANLA1617].UKPRN = LearningProvider.UKPRN
							and [LearningProvider_vw_ContractValidation_ANLA1617].fundingStreamPeriodCode = 'ANLA1617'

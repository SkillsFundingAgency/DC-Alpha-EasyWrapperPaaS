...
select
	@ukprn=[UKPRN]
from
	[Intrajob].[Valid].[LearningProvider]
...
from
	[Intrajob].[Rulebase].[AEC_LearningDelivery_Period]
...
select
	...
	[Period_12]
from
	[Intrajob].[Rulebase].[AEC_LearningDelivery_PeriodisedValues]
...
select
	...
	[Period_12]
from
	[Intrajob].[Rulebase].[AEC_LearningDelivery_PeriodisedTextValues]
...
from
	[Intrajob].[Rulebase].[AEC_ApprenticeshipPriceEpisode_Period]
...
--	[EpisodeStartDate],
	...
	[Period_12]
from
	[Intrajob].[Rulebase].[AEC_ApprenticeshipPriceEpisode_PeriodisedValues]
...
select
	...
	[HistoricUptoEndDateOutput]
from
	[Intrajob].[Rulebase].[AEC_HistoricEarningOutput]
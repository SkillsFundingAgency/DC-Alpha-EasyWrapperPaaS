...
-- Date: 07 September 2015 14:40
-- Profile: 1516 Test Harness Calculation
-- Rulebase Version: DCSS 1516 Derived Variables 1516, Drop 000, Version 1516.09
-- =====================================================================================================
			...
			convert(xml,
				(
					select
						...
						select
							...
							select
								...
								[LearnerEmploymentStatus].[EmpStatMon_BSI] as [@EmpStatMon_BSI],
								[LearnerEmploymentStatus].[EmpStatMon_EII] as [@EmpStatMon_EII],
								[LearnerEmploymentStatus].[EmpStatMon_LOE] as [@EmpStatMon_LOE],
								[LearnerEmploymentStatus].[EmpStatMon_LOU] as [@EmpStatMon_LOU],
								[LearnerEmploymentStatus].[EmpStatMon_PEI] as [@EmpStatMon_PEI],
								[LearnerEmploymentStatus].[EmpStatMon_RON] as [@EmpStatMon_RON],
								[LearnerEmploymentStatus].[EmpStatMon_SEI] as [@EmpStatMon_SEI],
							...
							select
								...
								where
									[LearningDeliveryHE].[LearnRefNumber] = [LearningDelivery].[LearnRefNumber]
								...
								from
									[$(LARS)].[Version_003].[LARS_Validity]
								where
							...
							from
								...
								left join [$(SourceDatabase)].[dbo].[ALB_LearningDelivery]
									on [ALB_LearningDelivery].[LearnRefNumber]=[LearningDelivery].[LearnRefNumber]
									and [ALB_LearningDelivery].[AimSeqNumber]=[LearningDelivery].[AimSeqNumber]
								...
								left join [$(LARS)].[Version_003].[LARS_Section96]
									on [LARS_Section96].[LearnAimRef]=[LearningDelivery].[LearnAimRef]
								left join [$(SourceDatabase)].[dbo].[SFA_LearningDelivery]
									on [SFA_LearningDelivery].[LearnRefNumber]=[LearningDelivery].[LearnRefNumber]
									and [SFA_LearningDelivery].[AimSeqNumber]=[LearningDelivery].[AimSeqNumber]
							where
						...
						from
							[Valid].[Learner]
							left join [$(SourceDatabase)].[dbo].[EFA_Learner]
					...
					from
						...
						left join [$(Org)].[Version_002].[ORG_Details]

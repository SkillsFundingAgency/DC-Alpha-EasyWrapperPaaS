		...
		<session-data>
			...
			<entity>
				...
				<xsl:for-each select="global">
					...
					<xsl:variable name="var_FCT_1618APPS1516" select="@FCT_1618APPS1516"/>
					<xsl:variable name="var_FCT_24PlusALLB1516" select="@FCT_24PlusALLB1516"/>
					<xsl:variable name="var_FCT_24PlusALLBC1516" select="@FCT_24PlusALLBC1516"/>
					<xsl:variable name="var_FCT_ASC1516" select="@FCT_ASC1516"/>
					<xsl:variable name="var_FCT_ASTO1516" select="@FCT_ASTO1516"/>
					<xsl:variable name="var_FCT_ESF1420" select="@FCT_ESF1420"/>
					<xsl:variable name="var_FCT_OLASS1516" select="@FCT_OLASS1516"/>
					...
					<instance>
						...
						<xsl:if test="string(boolean($var_FCT_1618APPS1516)) != 'false'">
							<attribute>
								<xsl:attribute name="id">FCT_1618APPS1516</xsl:attribute>
								<boolean-val>
									<xsl:value-of select="string($var_FCT_1618APPS1516)"/>
								</boolean-val>
							</attribute>
						</xsl:if>
						<xsl:if test="string(boolean($var_FCT_24PlusALLB1516)) != 'false'">
							<attribute>
								<xsl:attribute name="id">FCT_24PlusALLB1516</xsl:attribute>
								<boolean-val>
									<xsl:value-of select="string($var_FCT_24PlusALLB1516)"/>
								</boolean-val>
							</attribute>
						</xsl:if>
						<xsl:if test="string(boolean($var_FCT_24PlusALLBC1516)) != 'false'">
							<attribute>
								<xsl:attribute name="id">FCT_24PlusALLBC1516</xsl:attribute>
								<boolean-val>
									<xsl:value-of select="string($var_FCT_24PlusALLBC1516)"/>
								</boolean-val>
							</attribute>
						</xsl:if>
						<xsl:if test="string(boolean($var_FCT_ASC1516)) != 'false'">
							<attribute>
								<xsl:attribute name="id">FCT_ASC1516</xsl:attribute>
								<boolean-val>
									<xsl:value-of select="string($var_FCT_ASC1516)"/>
								</boolean-val>
							</attribute>
						</xsl:if>
						<xsl:if test="string(boolean($var_FCT_ASTO1516)) != 'false'">
							<attribute>
								<xsl:attribute name="id">FCT_ASTO1516</xsl:attribute>
								<boolean-val>
									<xsl:value-of select="string($var_FCT_ASTO1516)"/>
								</boolean-val>
							</attribute>
						</xsl:if>
						...
						<xsl:if test="string(boolean($var_FCT_OLASS1516)) != 'false'">
							<attribute>
								<xsl:attribute name="id">FCT_OLASS1516</xsl:attribute>
								<boolean-val>
									<xsl:value-of select="string($var_FCT_OLASS1516)"/>
								</boolean-val>
							</attribute>
						</xsl:if>

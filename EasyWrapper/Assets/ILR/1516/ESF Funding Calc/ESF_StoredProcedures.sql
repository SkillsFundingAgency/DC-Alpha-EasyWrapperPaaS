							...
							select
								...
								(
									select
										...
										(
											select
												[LearningDelivery_vw_ContractDescription_DeliverableCodeMappings].[contractAllocationEndDate] as [@EffectiveContractEndDate],
												[LearningDelivery_vw_ContractDescription_DeliverableCodeMappings].[contractAllocationStartDate] as [@EffectiveContractStartDate],
											...
											from
												(
													select
														[vw_ContractDescription].[contractAllocationEndDate],
														[vw_ContractDescription].[contractAllocationStartDate],
										...
										(
											...
											where
												...
												and [LARS_Funding].[FundingCategory]='ESF'
									...
									from
										...
										left join [$(PostcodeFactors)].[$(PostcodeFactors_Schema)].[PostcodeAreaCost]

...
BEGIN
	SELECT (
		(SELECT * FROM (
			...
			From Report.FundingSummary_1618 Where SubGroupHeader in ('ILR 16-18 Apprenticeships Frameworks Programme Funding','ILR 16-18 Apprenticeships Frameworks Learning Support') UNION
			SELECT 'EAS Total 16-18 Apprenticeship Frameworks Earnings Adjustment' as SubGroupHeader,8 as SortOrder,'LineTotals1618Apprenticeship' as DataSetName,
				...
				sum(FundCalcNov) AS FundCalcNov,sum(FundCalcDec) AS FundCalcDec,
				sum(FundCalcJan) AS FundCalcJan,sum(FundCalcFeb) AS FundCalcFeb,sum(FundCalcMar) AS FundCalcMar,sum(FundCalcApr) AS FundCalcApr,sum(FundCalcMay) AS FundCalcMay,sum(FundCalcJun) AS FundCalcJun,sum(FundCalcJul) AS FundCalcJul
			From Report.FundingSummary_1618 Where SubGroupHeader NOT in ('ILR 16-18 Apprenticeships Frameworks Programme Funding','ILR 16-18 Apprenticeships Frameworks Learning Support') UNION
			SELECT [SubGroupHeader],[SortOrder],[DataSetName],[YTDCalc],[TotalCalc],[AugToMar],[AprToJul] ,[FundCalcAug],[FundCalcSep],
					[FundCalcOct],[FundCalcNov],[FundCalcDec] ,[FundCalcJan],[FundCalcFeb],[FundCalcMar],[FundCalcApr] ,[FundCalcMay] ,[FundCalcJun] ,[FundCalcJul]
			...
			sum(FundCalcNov) AS FundCalcNov,sum(FundCalcDec) AS FundCalcDec,
			sum(FundCalcJan) AS FundCalcJan,sum(FundCalcFeb) AS FundCalcFeb,sum(FundCalcMar) AS FundCalcMar,sum(FundCalcApr) AS FundCalcApr,sum(FundCalcMay) AS FundCalcMay,sum(FundCalcJun) AS FundCalcJun,sum(FundCalcJul) AS FundCalcJul
			From Report.FundingSummary_1923 Where SubGroupHeader in ('ILR 19-23 Apprenticeships Frameworks Programme Funding','ILR 19-23 Apprenticeships Frameworks Learning Support') UNION
			...
			sum(FundCalcNov) AS FundCalcNov,sum(FundCalcDec) AS FundCalcDec,
			sum(FundCalcJan) AS FundCalcJan,sum(FundCalcFeb) AS FundCalcFeb,sum(FundCalcMar) AS FundCalcMar,sum(FundCalcApr) AS FundCalcApr,sum(FundCalcMay) AS FundCalcMay,sum(FundCalcJun) AS FundCalcJun,sum(FundCalcJul) AS FundCalcJul
			From Report.FundingSummary_1923 Where SubGroupHeader NOT in ('ILR 19-23 Apprenticeships Frameworks Programme Funding','ILR 19-23 Apprenticeships Frameworks Learning Support') UNION
			SELECT [SubGroupHeader],[SortOrder],[DataSetName],[YTDCalc],[TotalCalc],[AugToMar],[AprToJul] ,[FundCalcAug],[FundCalcSep],
					[FundCalcOct],[FundCalcNov],[FundCalcDec] ,[FundCalcJan],[FundCalcFeb],[FundCalcMar],[FundCalcApr] ,[FundCalcMay] ,[FundCalcJun] ,[FundCalcJul]
			...
			sum(FundCalcNov) AS FundCalcNov,sum(FundCalcDec) AS FundCalcDec,
			sum(FundCalcJan) AS FundCalcJan,sum(FundCalcFeb) AS FundCalcFeb,sum(FundCalcMar) AS FundCalcMar,sum(FundCalcApr) AS FundCalcApr,sum(FundCalcMay) AS FundCalcMay,sum(FundCalcJun) AS FundCalcJun,sum(FundCalcJul) AS FundCalcJul
			From Report.FundingSummary_24Plus Where SubGroupHeader in ('ILR 24+ Apprenticeships Frameworks Programme Funding','ILR 24+ Apprenticeships Frameworks Learning Support') UNION
			...
			sum(FundCalcNov) AS FundCalcNov,sum(FundCalcDec) AS FundCalcDec,
			sum(FundCalcJan) AS FundCalcJan,sum(FundCalcFeb) AS FundCalcFeb,sum(FundCalcMar) AS FundCalcMar,sum(FundCalcApr) AS FundCalcApr,sum(FundCalcMay) AS FundCalcMay,sum(FundCalcJun) AS FundCalcJun,sum(FundCalcJul) AS FundCalcJul
			From Report.FundingSummary_24Plus Where SubGroupHeader NOT in ('ILR 24+ Apprenticeships Frameworks Programme Funding','ILR 24+ Apprenticeships Frameworks Learning Support') UNION
			SELECT [SubGroupHeader],[SortOrder],[DataSetName],[YTDCalc],[TotalCalc],[AugToMar],[AprToJul] ,[FundCalcAug],[FundCalcSep],
					[FundCalcOct],[FundCalcNov],[FundCalcDec] ,[FundCalcJan],[FundCalcFeb],[FundCalcMar],[FundCalcApr] ,[FundCalcMay] ,[FundCalcJun] ,[FundCalcJul]
			...
			SELECT [SubGroupHeader],[SortOrder],[DataSetName],[YTDCalc],[TotalCalc],[AugToMar],[AprToJul] ,[FundCalcAug],[FundCalcSep],
					[FundCalcOct],[FundCalcNov],[FundCalcDec] ,[FundCalcJan],[FundCalcFeb],[FundCalcMar],[FundCalcApr] ,[FundCalcMay] ,[FundCalcJun] ,[FundCalcJul]
			from Report.FundingSummary_1924Traineeships UNION
			SELECT 'ILR Total 19-24 Traineeships' as SubGroupHeader,4 as SortOrder,'LineTotals1924Traineeships' as DataSetName,
			SUM(YTDCalc) AS YTDCalc, SUM (TotalCalc) AS TotalCalc,sum(AugToMar) AS AugToMar,sum(AprToJul) AS AprToJul,sum(FundCalcAug) AS FundCalcAug,sum(FundCalcSep) AS FundCalcSep,sum(FundCalcOct) AS FundCalcOct,
			sum(FundCalcNov) AS FundCalcNov,sum(FundCalcDec) AS FundCalcDec,
			sum(FundCalcJan) AS FundCalcJan,sum(FundCalcFeb) AS FundCalcFeb,sum(FundCalcMar) AS FundCalcMar,sum(FundCalcApr) AS FundCalcApr,sum(FundCalcMay) AS FundCalcMay,sum(FundCalcJun) AS FundCalcJun,sum(FundCalcJul) AS FundCalcJul
			From Report.FundingSummary_1924Traineeships Where SubGroupHeader in ('ILR 19-24 Traineeships Programme Funding','ILR 19-24 Traineeships (EFA Model) Programme Funding','ILR 19-24 Traineeships Learning Support') UNION
			...
			sum(FundCalcNov) AS FundCalcNov,sum(FundCalcDec) AS FundCalcDec,
			sum(FundCalcJan) AS FundCalcJan,sum(FundCalcFeb) AS FundCalcFeb,sum(FundCalcMar) AS FundCalcMar,sum(FundCalcApr) AS FundCalcApr,sum(FundCalcMay) AS FundCalcMay,sum(FundCalcJun) AS FundCalcJun,sum(FundCalcJul) AS FundCalcJul
			From Report.FundingSummary_1924Traineeships Where SubGroupHeader NOT in ('ILR 19-24 Traineeships Programme Funding','ILR 19-24 Traineeships (EFA Model) Programme Funding','ILR 19-24 Traineeships Learning Support') UNION
			SELECT [SubGroupHeader],[SortOrder],[DataSetName],[YTDCalc],[TotalCalc],[AugToMar],[AprToJul] ,[FundCalcAug],[FundCalcSep],
					[FundCalcOct],[FundCalcNov],[FundCalcDec] ,[FundCalcJan],[FundCalcFeb],[FundCalcMar],[FundCalcApr] ,[FundCalcMay] ,[FundCalcJun] ,[FundCalcJul]
			...
			sum(FundCalcNov) AS FundCalcNov,sum(FundCalcDec) AS FundCalcDec,
			sum(FundCalcJan) AS FundCalcJan,sum(FundCalcFeb) AS FundCalcFeb,sum(FundCalcMar) AS FundCalcMar,sum(FundCalcApr) AS FundCalcApr,sum(FundCalcMay) AS FundCalcMay,sum(FundCalcJun) AS FundCalcJun,sum(FundCalcJul) AS FundCalcJul
			From Report.[FundingSummary_AebOther] Where SubGroupHeader in ('ILR AEB - Other Learning Programme Funding','ILR AEB - Other Learning Learning Support', 'ILR AEB - Other Learning (EFA Model) Programme Funding', 'ILR AEB - Other Learning (25+ High Needs Students) Programme Funding')
			UNION
			...
			sum(FundCalcNov) AS FundCalcNov,sum(FundCalcDec) AS FundCalcDec,
			sum(FundCalcJan) AS FundCalcJan,sum(FundCalcFeb) AS FundCalcFeb,sum(FundCalcMar) AS FundCalcMar,sum(FundCalcApr) AS FundCalcApr,sum(FundCalcMay) AS FundCalcMay,sum(FundCalcJun) AS FundCalcJun,sum(FundCalcJul) AS FundCalcJul
			From Report.[FundingSummary_AebOther] Where SubGroupHeader NOT in ('ILR AEB - Other Learning Programme Funding', 'ILR AEB - Other Learning Learning Support', 'ILR AEB - Other Learning (EFA Model) Programme Funding', 'ILR AEB - Other Learning (25+ High Needs Students) Programme Funding') UNION
			SELECT [SubGroupHeader],[SortOrder],[DataSetName],[YTDCalc],[TotalCalc],[AugToMar],[AprToJul] ,[FundCalcAug],[FundCalcSep],
					[FundCalcOct],[FundCalcNov],[FundCalcDec] ,[FundCalcJan],[FundCalcFeb],[FundCalcMar],[FundCalcApr] ,[FundCalcMay] ,[FundCalcJun] ,[FundCalcJul]
			FROM Report.[FundingSummary_TotalAebOther]
			UNION 
			--LineTotalsAdultSkillsBudget
			SELECT * FROM [Report].[FundingSummary_TotalAdultBudget]
			UNION
			--LineTotalsAdultCummalative
			 SELECT 'Total Adult Education Budget Cumulative' as SubGroupHeader,1 as SortOrder,'LineTotalsAdultBudgetCummalative' as DataSetName,YTDCalc, TotalCalc,AugToMar,AprToJul ,
			FundCalcAug,FundCalcAug+FundCalcSep as FundCalcSep,FundCalcAug+FundCalcSep+FundCalcOct as FundCalcOct,FundCalcAug+FundCalcSep+FundCalcOct+FundCalcNov as FundCalcNov,
			FundCalcAug+FundCalcSep+FundCalcOct+FundCalcNov+FundCalcDec asFundCalcDec,FundCalcAug+FundCalcSep+FundCalcOct+FundCalcNov+FundCalcDec+FundCalcJan as FundCalcJan,FundCalcAug+FundCalcSep+FundCalcOct+FundCalcNov+FundCalcDec+FundCalcJan+FundCalcFeb as FundCalcFeb,
			FundCalcAug+FundCalcSep+FundCalcOct+FundCalcNov+FundCalcDec+FundCalcJan+FundCalcFeb+FundCalcMar as FundCalcMar,FundCalcAug+FundCalcSep+FundCalcOct+FundCalcNov+FundCalcDec+FundCalcJan+FundCalcFeb+FundCalcMar+FundCalcApr as FundCalcApr
			,FundCalcAug+FundCalcSep+FundCalcOct+FundCalcNov+FundCalcDec+FundCalcJan+FundCalcFeb+FundCalcMar+FundCalcApr+FundCalcMay as FundCalcMay,FundCalcAug+FundCalcSep+FundCalcOct+FundCalcNov+FundCalcDec+FundCalcJan+FundCalcFeb+FundCalcMar+FundCalcApr+FundCalcMay+FundCalcJun as FundCalcJun,
			...
			,'ILR 19-23 Trailblazer Apprenticeships Employer Incentive Payments (Achievement, Small Employer)','ILR 19-23 Trailblazer Apprenticeships Learning Support') UNION
			SELECT [SubGroupHeader],[SortOrder],[DataSetName],[YTDCalc],[TotalCalc],[AugToMar],[AprToJul] ,[FundCalcAug],[FundCalcSep],
					[FundCalcOct],[FundCalcNov],[FundCalcDec] ,[FundCalcJan],[FundCalcFeb],[FundCalcMar],[FundCalcApr] ,[FundCalcMay] ,[FundCalcJun] ,[FundCalcJul]
			...
			,'ILR 24+ Trailblazer Apprenticeships Employer Incentive Payments (Achievement, Small Employer)','ILR 24+ Trailblazer Apprenticeships Learning Support') UNION
			SELECT [SubGroupHeader],[SortOrder],[DataSetName],[YTDCalc],[TotalCalc],[AugToMar],[AprToJul] ,[FundCalcAug],[FundCalcSep],
					[FundCalcOct],[FundCalcNov],[FundCalcDec] ,[FundCalcJan],[FundCalcFeb],[FundCalcMar],[FundCalcApr] ,[FundCalcMay] ,[FundCalcJun] ,[FundCalcJul]
			...
			SELECT 'Total Exceptional Learning Support Earnings Adjustment' as SubGroupHeader,16 as SortOrder,'LineTotalsExceptionalLearningSupport' as DataSetName,
			SUM(YTDCalc) AS YTDCalc, SUM (TotalCalc) AS TotalCalc,sum(AugToMar) AS AugToMar,sum(AprToJul) AS AprToJul,sum(FundCalcAug) AS FundCalcAug,sum(FundCalcSep) AS FundCalcSep,sum(FundCalcOct) AS FundCalcOct,
			sum(FundCalcNov) AS FundCalcNov,sum(FundCalcDec) AS FundCalcDec,
			sum(FundCalcJan) AS FundCalcJan,sum(FundCalcFeb) AS FundCalcFeb,sum(FundCalcMar) AS FundCalcMar,sum(FundCalcApr) AS FundCalcApr,sum(FundCalcMay) AS FundCalcMay,sum(FundCalcJun) AS FundCalcJun,sum(FundCalcJul) AS FundCalcJul
			...
			SELECT * FROM [Report].[FundingSummary_TotalNonLevyBudget]
			UNION
			--LineTotalsNonLevyBudgetCummalative
				SELECT 'Total Non-Levy Contracted Apprenticeships Budget Cumulative for starts on or after 1 May 2017 ' as SubGroupHeader,1 as SortOrder,'LineTotalsNonLevyBudgetCummalative' as DataSetName,YTDCalc, TotalCalc,AugToMar,AprToJul ,
			FundCalcAug,FundCalcAug+FundCalcSep as FundCalcSep,FundCalcAug+FundCalcSep+FundCalcOct as FundCalcOct,FundCalcAug+FundCalcSep+FundCalcOct+FundCalcNov as FundCalcNov,
			FundCalcAug+FundCalcSep+FundCalcOct+FundCalcNov+FundCalcDec asFundCalcDec,FundCalcAug+FundCalcSep+FundCalcOct+FundCalcNov+FundCalcDec+FundCalcJan as FundCalcJan,FundCalcAug+FundCalcSep+FundCalcOct+FundCalcNov+FundCalcDec+FundCalcJan+FundCalcFeb as FundCalcFeb,
			FundCalcAug+FundCalcSep+FundCalcOct+FundCalcNov+FundCalcDec+FundCalcJan+FundCalcFeb+FundCalcMar as FundCalcMar,FundCalcAug+FundCalcSep+FundCalcOct+FundCalcNov+FundCalcDec+FundCalcJan+FundCalcFeb+FundCalcMar+FundCalcApr as FundCalcApr
			,FundCalcAug+FundCalcSep+FundCalcOct+FundCalcNov+FundCalcDec+FundCalcJan+FundCalcFeb+FundCalcMar+FundCalcApr+FundCalcMay as FundCalcMay,FundCalcAug+FundCalcSep+FundCalcOct+FundCalcNov+FundCalcDec+FundCalcJan+FundCalcFeb+FundCalcMar+FundCalcApr+FundCalcMay+FundCalcJun as FundCalcJun,
			FundCalcAug+FundCalcSep+FundCalcOct+FundCalcNov+FundCalcDec+FundCalcJan+FundCalcFeb+FundCalcMar+FundCalcApr+FundCalcMay+FundCalcJun+FundCalcJul as FundCalcJul
			FROM [Report].[FundingSummary_TotalNonLevyBudget]

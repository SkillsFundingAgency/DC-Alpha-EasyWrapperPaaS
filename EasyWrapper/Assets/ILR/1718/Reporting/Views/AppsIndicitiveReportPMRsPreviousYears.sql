...
from Rulebase.AEC_ApprenticeshipPriceEpisode pe
	...
	AND TBAFR1.AFinCode = 1 AND TBAFR1.AFinDate < '${YearStartDate}' 
	--AFin2
	...
	AND TBAFR2.AFinCode = 2 AND TBAFR2.AFinDate < '${YearStartDate}'
	--AFin3
	...
	AND TBAFR3.AFinCode = 3 AND TBAFR3.AFinDate < '${YearStartDate}'
	--AFin4
	...
	AND TBAFR4.AFinCode = 4 AND TBAFR4.AFinDate < '${YearStartDate}'

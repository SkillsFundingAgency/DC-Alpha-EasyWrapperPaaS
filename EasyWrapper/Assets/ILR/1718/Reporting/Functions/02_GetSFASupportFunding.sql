...
(
	 SELECT
		...
		(CASE FundLine
			...
			WHEN 'AEB - Other Learning' THEN 15
			WHEN '19-24 Traineeship' THEN 12
		...
		(CASE FundLine
			...
			WHEN 'AEB - Other Learning' THEN 'AEB - Other Learning - Learning Support'
	...
	FROM (
		...
		SELECT FundLine, 
			(CASE FundLine
				...
				WHEN 'AEB - Other Learning' THEN (ISNULL((SELECT [Report].[GetSFALearnSuppFundCash]('AEB - Other Learning',0)),0) + ISNULL((SELECT [Report].[GetSFAEASForType]('Excess Learning Support: AEB-Other Learning', 0)),0))

				WHEN '19-24 Traineeship' THEN (ISNULL((SELECT [Report].[GetSFALearnSuppFundCash]('19-24 Traineeship',0)),0) + ISNULL((SELECT [Report].[GetSFAEASForType]('Excess Learning Support: 19-24 Traineeships', 0)),0))
			...
			(CASE FundLine
				...
				WHEN 'AEB - Other Learning' THEN (ISNULL((SELECT [Report].[GetSFALearnSuppFundCash]('AEB - Other Learning',1)),0) + ISNULL((SELECT [Report].[GetSFAEASForType]('Excess Learning Support: AEB-Other Learning', 1)),0))

				WHEN '19-24 Traineeship' THEN (ISNULL((SELECT [Report].[GetSFALearnSuppFundCash]('19-24 Traineeship',1)),0) + ISNULL((SELECT [Report].[GetSFAEASForType]('Excess Learning Support: 19-24 Traineeships', 1)),0))

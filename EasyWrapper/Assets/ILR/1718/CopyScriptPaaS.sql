...
select
	...
	,afr.AFinAmount
from
	[dbo].AppFinRecord as afr
	join
		[dbo].LearningDelivery as ld
...
from
	[dbo].DPOutcome as dp
	join
		[dbo].LearnerDestinationandProgression as ldp
...
select
	...
	,esm.ESMCode
from
	[dbo].EmploymentStatusMonitoring as esm
	join
		[dbo].LearnerEmploymentStatus as les
...
select
	...
	ULN
from
	[dbo].LearnerDestinationandProgression
go
...
select
	...
	,lhfs.FINAMOUNT
from
	[dbo].LearnerHEFinancialSupport as lhfs
	join
		[dbo].LearnerHE as lh
...
from
	[dbo].LearningDeliveryFAM as ldf
	join
		[dbo].LearningDelivery as ld
...
select
	...
	,ldwp.WorkPlaceEmpId
from
	[dbo].LearningDeliveryWorkPlacement as ldwp
	join
		[dbo].LearningDelivery as ld
...
select
	...
	,lhp.PrimaryLLDD
from
	[dbo].LLDDandHealthProblem as lhp
	join
		[dbo].Learner as l
...
select
	...
	,psdm.ProvSpecDelMon
from
	[dbo].ProviderSpecDeliveryMonitoring as psdm
	join
		[dbo].LearningDelivery as ld
...
from	
	[dbo].ProviderSpecLearnerMonitoring as pslm
	join
		[dbo].Learner as l

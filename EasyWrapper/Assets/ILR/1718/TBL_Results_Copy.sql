--TBL_Results_Copy
insert into [$(FromILRDatabase)].Rulebase.[TBL_Cases]
(
	LearnRefNumber
	,CaseData
)
...
insert into [$(FromILRDatabase)].Rulebase.[TBL_global]
(
	UKPRN, 
	CurFundYr, 
	LARSVersion, 
...
insert into [$(FromILRDatabase)].[Rulebase].[TBL_LearningDelivery]
(
	LearnRefNumber, 
	AimSeqNumber, 
...
insert into [$(FromILRDatabase)].Rulebase.[TBL_LearningDelivery_Period]
(
	LearnRefNumber, 
	AimSeqNumber, 
	[Period], 
...
insert into [$(FromILRDatabase)].[Rulebase].[TBL_LearningDelivery_PeriodisedValues]
(
	LearnRefNumber, 
	AimSeqNumber, 
	AttributeName, 

			...
			convert(xml,
				(
					select
						...
						,case when [1618APPS1617Contract].UKPRN is not null then 'true' else 'false' end as [@FCT_1618APPS1617]
						...
						,case when [24PlusALLBC1617Contract].UKPRN is not null then 'true' else 'false' end as [@FCT_24PlusALLBC1617]
						,case when [AAC1617Contract].UKPRN is not null then 'true' else 'false' end as [@FCT_AAC1617]
						,case when [AAPP1718Contract].UKPRN is not null then 'true' else 'false' end as [@FCT_AAPP1718]
						,case when [AATO1617Contract].UKPRN is not null then 'true' else 'false' end as [@FCT_AATO1617]
						...
						,case when [ASC1617Contract].UKPRN is not null then 'true' else 'false' end as [@FCT_ASC1617]
						,case when [ASTO1617Contract].UKPRN is not null then 'true' else 'false' end as [@FCT_ASTO1617]
						...
						,case when [OLASS1617Conract].UKPRN is not null then 'true' else 'false' end as [@FCT_OLASS1617]
						...
						,(
							select
								...
								[Learner].[AddLine1] as [@AddLine1],
								Learner.AddLine2 as [@AddLine2],
								Learner.AddLine3 as [@AddLine3],
								...
								Learner.PMUKPRN as [@PMUKPRN],
								Learner.Postcode as [@Postcode],
								Learner.PostcodePrior as [@PostcodePrior],
										...
										(
											...
											from
												(
													...
													from
														[$(LARS)].[$(LARS_Schema)].[LARS__LearningDeliveryCategory_Children]
					...
					from
						...
						left join (
								...
								from
									[$(FCT)].[$(FCT_Schema)].[vw_ContractAllocation]
							...
							and [LearningProvider_vw_ContractValidation_1618APPS1617].[fundingStreamPeriodCode]='16-18APPS1718'
						left join (
							select distinct
								[cv].UKPRN
							...
							on [16-18APPS1718Contract].UKPRN = LearningProvider.UKPRN
						...
						left join (
							...
							on [16-18NLA1718Contract].UKPRN = LearningProvider.UKPRN
							[16-18NLA1718Contract].fundingStreamPeriodCode = '16-18NLA1718'
						left join (
							select distinct
								[cv].UKPRN
								,cv.fundingStreamPeriodCode
							from
								[$(FCT)].[$(FCT_Schema)].[vw_ContractValidation] as cv
						) as [24PlusALLBC1617Contract]
							on [24PlusALLBC1617Contract].UKPRN = LearningProvider.UKPRN
							and [24PlusALLBC1617Contract].fundingStreamPeriodCode = '24PlusALLBC1617'
						left join (
							select distinct
								[cv].UKPRN
								,cv.fundingStreamPeriodCode
							...
							on [AAC1617Contract].UKPRN = LearningProvider.UKPRN
							and [AAC1617Contract].fundingStreamPeriodCode = 'AAC1617'
						left join (
							select distinct
								[cv].UKPRN
								,cv.fundingStreamPeriodCode
							...
							on [AAPP1718Contract].UKPRN = LearningProvider.UKPRN
						...
						left join (
							...
							on [AATO1617Contract].UKPRN = LearningProvider.UKPRN
							and [AATO1617Contract].fundingStreamPeriodCode = 'AATO1617'
						left join (
							select distinct
								[cv].UKPRN
								,cv.fundingStreamPeriodCode
							...
							on [AEBC1718Contract].UKPRN = LearningProvider.UKPRN
						...
						left join (
							...
							on [AEBTO-TOL1718Contract].UKPRN = LearningProvider.UKPRN
						...
						left join (
							...
							on [ALLB1718Contract].UKPRN = LearningProvider.UKPRN
						...
						left join (
							...
							on [ALLBC1718Contract].UKPRN = LearningProvider.UKPRN
						...
						left join (
							...
							on [ANLA1718Contract].UKPRN = LearningProvider.UKPRN
						...
						left join (
							...
							on [ASC1617Contract].UKPRN = LearningProvider.UKPRN
							and [ASC1617Contract].fundingStreamPeriodCode = 'ASC1617'
						left join (
							select distinct
								[cv].UKPRN
								,cv.fundingStreamPeriodCode
							...
							on [ASTO1617Contract].UKPRN = LearningProvider.UKPRN
							and [ASTO1617Contract].fundingStreamPeriodCode = 'ASTO1617'
						left join (
							select distinct
								[cv].UKPRN
								,cv.fundingStreamPeriodCode
							...
							on [ESF1420Contract].UKPRN = LearningProvider.UKPRN
						...
						left join (
							...
							on [LEVY1799Contract].UKPRN = LearningProvider.UKPRN
						...
						left join (
							...
							from
								[$(FCT)].[$(FCT_Schema)].[vw_ContractValidation] as cv
						) as [OLASS1617Contract]
							on [OLASS1617Contract].UKPRN = LearningProvider.UKPRN
							and [OLASS1617Contract].fundingStreamPeriodCode = 'OLASS1617'

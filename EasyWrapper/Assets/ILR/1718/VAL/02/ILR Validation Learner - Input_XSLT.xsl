		...
		<session-data>
			...
			<entity>
				...
				<xsl:for-each select="global">
					...
					<xsl:variable name="var_FCT_AEBTO_TOL1718" select="@FCT_AEBTO_TOL1718"/>
					...
					<instance>
						...
						<xsl:if test="string(boolean($var_FCT_16-18APPS1718)) != 'false'">
							<attribute>
								...
								<boolean-val>
									<xsl:value-of select="string(boolean($var_FCT_16-18APPS1718))"/>
								</boolean-val>
							</attribute>
						</xsl:if>
						...
						<xsl:if test="string(boolean($var_FCT_AEBTO_TOL1718)) != 'false'">
							<attribute>
								<xsl:attribute name="id">FCT_AEBTO_TOL1718</xsl:attribute>
								<boolean-val>
									<xsl:value-of select="string($var_FCT_AEBTO_TOL1718)"/>
								</boolean-val>
							</attribute>
						</xsl:if>
											...
											<instance>
												...
												<xsl:if test="string(boolean($var_EPAOrgId)) != 'false'">
													<attribute>
														...
														<text-val>
															<xsl:value-of select="$var_EPAOrgId"/>
														</text-val>
													</attribute>
												</xsl:if>

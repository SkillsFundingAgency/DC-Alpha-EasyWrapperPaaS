			...
			convert(xml,
				(
					select
						...
						,case when [OLASS1617Contract].UKPRN is not null then 'true' else 'false' end as [@FCT_OLASS1617]
						...
						,(
							...
							from
								...
								(
									...
									on PMUKPRNLookUp.UKPRN = Learner.PMUKPRN
								left join
								(
									select
										Postcode
									...
									on PCLookup.Postcode = Learner.Postcode
								left join
								(
									select 
										Postcode
									...
									on PrevPCLookup.Postcode = Learner.PostcodePrior
							where

--AEC_Results_copy_old


----AEC_Results_Copy.sql
...
--declare @ukprn int = (select top 1 UKPRN from Rulebase.AEC_global);
...
select
	(select top 1 UKPRN from Rulebase.AEC_global),
	'${year}',
	[LARSVersion],
	[RulebaseVersion]
from
...
exec [ApprenticeshipEarningsHistory].[dbo].[PrepareForNewData] '${year}', 'R01', @pUKPRN
go

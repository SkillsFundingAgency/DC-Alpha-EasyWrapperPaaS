				...
				(
					select
						...
						(
							select
								...
								(
									...
									from
										...
										join Valid.LearningDeliveryDenorm as ldd
											on ld.LearnRefNumber = ldd.LearnRefNumber
											and ld.AimSeqNumber = ldd.AimSeqNumber														
								...
								(
									select
										...
										(
											...
											from
												[$(LargeEmployers)].[$(LargeEmployers_Schema)].[LargeEmployers]
											where
								...
								(
									...
									from
										[$(PostcodeFactors)].[$(PostcodeFactors_Schema)].[SFA_PostcodeDisadvantage]
									where
						...
						(
							...
							from
								[$(Org)].[$(Org_Schema)].[Org_Funding]
							where
								[Org_Funding].[UKPRN]=lp.[UKPRN]

--SFA_Results_Copy
insert into [$(FromILRDatabase)].Rulebase.[SFA_Cases]
(
	LearnRefNumber
	,CaseData
)
...
insert into [$(FromILRDatabase)].Rulebase.[SFA_global]
(
	UKPRN, 
	CurFundYr, 
	LARSVersion, 
...
insert into [$(FromILRDatabase)].Rulebase.[SFA_LearningDelivery]
(
	LearnRefNumber, 
	AimSeqNumber, 
	AchApplicDate, 
...
insert into [$(FromILRDatabase)].Rulebase.[SFA_LearningDelivery_Period]
(
	LearnRefNumber, 
	AimSeqNumber, 
	[Period], 
...
insert into [$(FromILRDatabase)].Rulebase.[SFA_LearningDelivery_PeriodisedValues]
(
	LearnRefNumber, 
	AimSeqNumber, 
	AttributeName, 

...
select
	...
	,UKPRN
from
	[$(FromILRDatabase)].[dbo].LearningProvider
go
...
select
	...
	,[Collection]
from
	[$(FromILRDatabase)].[dbo].CollectionDetails
go
...
select
	...
	,[SerialNo]
from
	[$(FromILRDatabase)].[dbo].SourceFile
go
...
select
	...
	,afr.AFinAmount
from
	[$(FromILRDatabase)].[dbo].AppFinRecord as afr
	join
		[$(FromILRDatabase)].[dbo].LearningDelivery as ld
			on ld.PK_LearningDelivery = afr.FK_LearningDelivery
	join
		[$(FromILRDatabase)].[dbo].Learner as l
...
select
	...
	,cp.ContPrefCode
from
	[$(FromILRDatabase)].[dbo].ContactPreference as cp
	join
		[$(FromILRDatabase)].[dbo].Learner as l
...
select
	...
	,dp.OutCollDate
from
	[$(FromILRDatabase)].[dbo].DPOutcome as dp
	join
		[$(FromILRDatabase)].[dbo].LearnerDestinationandProgression as ldp
...
select
	...
	,esm.ESMCode
from
	[$(FromILRDatabase)].[dbo].EmploymentStatusMonitoring as esm
	join
		[$(FromILRDatabase)].[dbo].LearnerEmploymentStatus as les
...
select
	...
	ULN
from
	[$(FromILRDatabase)].[dbo].LearnerDestinationandProgression
go
...
select
	...
	,lf.LearnFAMCode
from
	[$(FromILRDatabase)].[dbo].LearnerFAM as lf
	join
		[$(FromILRDatabase)].[dbo].Learner as l
...
select
	...
	,lh.TTACCOM
from
	[$(FromILRDatabase)].[dbo].LearnerHE as lh
	join
		[$(FromILRDatabase)].[dbo].Learner as l
...
select
	...
	,lhfs.FINAMOUNT
from
	[$(FromILRDatabase)].[dbo].LearnerHEFinancialSupport as lhfs
	join
		[$(FromILRDatabase)].[dbo].LearnerHE as lh
...
from
	[$(FromILRDatabase)].[dbo].LearningDeliveryFAM as ldf
	join
		[$(FromILRDatabase)].[dbo].LearningDelivery as ld
...
select
	...
	ldh.HEPostCode
from
	[$(FromILRDatabase)].[dbo].LearningDeliveryHE as ldh
	join
		[$(FromILRDatabase)].[dbo].LearningDelivery as ld
...
select
	...
	,ldwp.WorkPlaceEmpId
from
	[$(FromILRDatabase)].[dbo].LearningDeliveryWorkPlacement as ldwp
	join
		[$(FromILRDatabase)].[dbo].LearningDelivery as ld
...
select
	...
	,lhp.PrimaryLLDD
from
	[$(FromILRDatabase)].[dbo].LLDDandHealthProblem as lhp
	join
		[$(FromILRDatabase)].[dbo].Learner as l
...
select
	...
	,psdm.ProvSpecDelMon
from
	[$(FromILRDatabase)].[dbo].ProviderSpecDeliveryMonitoring as psdm
	join
		[$(FromILRDatabase)].[dbo].LearningDelivery as ld
...
from	
	[$(FromILRDatabase)].[dbo].ProviderSpecLearnerMonitoring as pslm
	join
		[$(FromILRDatabase)].[dbo].Learner as l
